...
A Cloudflare Worker that serves as a CDN for GitHub repositories, enabling access to both public and private repositories even in regions where GitHub might be restricted.

## Features

- Access files from both public and private GitHub repositories
- Access GitHub release downloads
- Works in regions where GitHub access is restricted
- Multiple URL formats for flexibility
- Performance benefits of Cloudflare's global edge network
- Proper caching for improved performance
- Handles binary files correctly
...
### In Clash Configuration Files

```
ruleset=✨ AI,https://cdn.example.com/gh/blackmatrix7/ios_rule_script/master/rule/Clash/OpenAI/OpenAI.list
ruleset=🎞️ Streaming,https://cdn.example.com/raw/your-private-repo/custom-rules/main/streaming.list
```
